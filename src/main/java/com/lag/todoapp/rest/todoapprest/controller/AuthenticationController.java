...
public class AuthenticationController {
    ...
    @PostMapping()
    public ResponseEntity<LoginDto> login(@Valid @RequestBody LoginEntradaDto userLogin) throws Exception {
        return ResponseEntity.ok(authenticationService.authenticate(userLogin));
    }

    @PostMapping("/register")
    public ResponseEntity<RegisterDto> register(@Valid @RequestBody RegisterEntradaDto userRegister) throws Exception {
